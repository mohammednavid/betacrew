  ...
  return (
    <>
      ...
      {pod1 && (
        <Fade>
          <div className={styles.homeCL}>
            <h2 className={styles.homeCLTitle}>CREW LEVEL 1</h2>
            <p className={styles.homeCLDescp}>
              These are entry-level engineers expected to be able to write
              modules and fix bugs. We expect them to be keen learners and
              perform well under a more senior engineer.
            </p>
          </div>
        </Fade>
      )}
      {pod2 && (
        <Fade>
          <div className={styles.homeCL}>
            <h2 className={styles.homeCLTitle}>CREW LEVEL 2</h2>
            <p className={styles.homeCLDescp}>
              ...
              features from conception to production. They are expected to
              review peer code, churn out high quality code without supervision
      ...
      {pod3 && (
        <Fade>
          <div className={styles.homeCL}>
            <h2 className={styles.homeCLTitle}>CREW LEVEL 3</h2>
            <p className={styles.homeCLDescp}>
      ...
      {pod4 && (
        <Fade>
          <div className={styles.homeCL}>
            <h2 className={styles.homeCLTitle}>CREW LEVEL 4</h2>
            <p className={styles.homeCLDescp}>
              ...
              processes, writing code/libraries that can be reused by team
              members and solving complex technical problems.
            </p>
          </div>
        </Fade>
      )}
